          ...
          <div className="fixed inset-0 top-[226px] bottom-[80px] left-[352px] right-24">
            <div className="relative w-full h-full mt-10">
              ...
              <button 
                ...
                className="absolute left-[72px] top-1/2 -translate-y-1/2 z-20 bg-white/80 hover:bg-white rounded-full p-2 shadow-lg transition-all"
              ...
              <div 
                ...
                className="flex overflow-x-auto overflow-y-hidden w-full h-full ml-8 pt-6 pb-12 scroll-smooth"
